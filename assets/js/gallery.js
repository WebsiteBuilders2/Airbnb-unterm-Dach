...
window.BREMEN_PLACES = [
  { file: "assets/img/bremen/marktplatz.jpg",  dist: "9 km",
    title: { de: "Marktplatz & Dom",   en: "Market Square & Cathedral" },
    text:  { de: "Rathaus, Roland und der St.-Petri-Dom – das UNESCO-Welterbe im Herzen der Stadt.",
             en: "Town hall, the Roland statue and St Peter's Cathedral – UNESCO World Heritage in the heart of the city." } },
  ...
  { file: "assets/img/bremen/wallanlagen.jpg", dist: "9 km",
    title: { de: "Wallanlagen",        en: "Wallanlagen park" },
    text:  { de: "Grüner Park am alten Stadtgraben, mit der Mühle am Wall als Wahrzeichen.",
             en: "Green park along the old city moat, with the Mühle am Wall windmill as its landmark." } },
];
